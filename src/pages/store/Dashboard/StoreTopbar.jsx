...
export default function StoreTopbar() {
  return (
    <header className="w-full h-16 bg-background border-b flex items-center px-4 sm:px-6 justify-between shadow-sm">
      {/* Left spacer for mobile hamburger button */}
      <div className="w-8 md:hidden" />

      {/* Search */}
      <div className="flex-1 max-w-xs sm:max-w-md relative mx-2 sm:mx-0">
      ...
      <div className="flex items-center gap-3 sm:gap-6">
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="hidden sm:inline font-medium text-foreground">Store Admin</span>
        </div>
      </div>
    </header>
  );
